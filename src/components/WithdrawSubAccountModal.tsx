...
interface WithdrawSubAccountModalProps {
    isOpen: boolean;
    onClose: () => void;
    onWithdraw: (subAccountName: string, amount: number) => Promise<void>;
    loading: boolean;
    subAccountName: string;
    maxAvailable: bigint; // This will be the actual SubAccount balance
}

export const WithdrawSubAccountModal: React.FC<WithdrawSubAccountModalProps> = ({
    isOpen, onClose, onWithdraw, loading, subAccountName, maxAvailable
}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        await onWithdraw(subAccountName, numAmount);
        setAmount("");
        onClose();
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-[2rem] p-8 w-full max-w-md relative z-10 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="mb-8 pr-12">
                    <h2 className="text-2xl font-extrabold text-gray-900 mb-2 tracking-tight">Withdraw from Sub-Account</h2>
                    <p className="text-gray-500 font-medium text-sm">
                        Move USDC from your <strong className="text-gray-900">{subAccountName}</strong> balance back to your main treasury.
                    </p>
                </div>
